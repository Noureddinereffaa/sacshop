      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-5 py-6">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            {/* Product Image */}
            {imageUrl && (
              <div style={{ width: "100%", maxHeight: "300px", overflow: "hidden", backgroundColor: "#f3f4f6" }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={imageUrl}
                  alt={productName}
            ...
            <div className="pt-6 pb-2 px-6 text-center">
              ...
              <div className="w-20 h-1 mx-auto bg-gradient-to-r from-yellow-400 via-primary to-pink-500 rounded-full mt-2 mb-5" />

              {/* Buttons - directly under welcome */}
              <div className="flex gap-3 mb-5">
                <button
                  onClick={goToDestination}
                  className="flex-1 bg-gradient-to-b from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white py-4 px-3 rounded-2xl font-black text-sm transition-all active:scale-[0.97] shadow-lg shadow-cyan-500/30 flex flex-col items-center gap-1"
                >
                ...
                <a
                  href={FACEBOOK_PAGE}
                  className="flex-1 bg-blue-700 hover:bg-blue-800 text-white py-4 px-3 rounded-2xl font-black text-sm transition-all active:scale-[0.97] shadow-lg shadow-blue-700/30 flex flex-col items-center gap-1"
                >
