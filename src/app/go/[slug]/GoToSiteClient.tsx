...
export default function GoToSiteClient({
  ...
  useEffect(() => {
    ...
    if (fb && android) {
      // Android + Facebook: try auto-breakout immediately
      ...
      // If still on page after 2.5s, show the landing page
      const timer = setTimeout(() => setShowPage(true), 2500);
      return () => clearTimeout(timer);
    }

    // iOS or non-Facebook: show page immediately
    setShowPage(true);
  }, [destination]);

  if (!showPage && isFacebook && isAndroid) {
    // Loading state while attempting breakout
    return (
      <div
        className="min-h-screen flex flex-col items-center justify-center px-4"
        style={{
          background: "linear-gradient(160deg, #00b4d8 0%, #0096c7 30%, #e6007e 70%, #ff6b6b 100%)",
        }}
      >
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(160deg, #00b4d8 0%, #0096c7 20%, #e6007e 65%, #ff6b6b 100%)",
      }}
    >
      {/* Decorative circles */}
      ...
      <div className="absolute top-1/3 left-8 w-4 h-4 bg-white/20 rounded-full" />
      <div className="absolute top-1/2 right-6 w-2 h-2 bg-pink-300/30 rounded-full" />
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="pt-8 pb-2 text-center">
              ...
              <h1 className="text-3xl font-black text-gray-900 mb-1">مرحباً بك!</h1>
              <div className="w-24 h-1 mx-auto bg-gradient-to-r from-yellow-400 via-primary to-pink-500 rounded-full mt-2" />
            </div>
            ...
            <div className="px-5 pb-6 flex gap-3">
              ...
              >
                ...
                <span className="text-blue-200 text-[10px] font-bold">العودة لمتابعة لا حظاً</span>
              </button>
