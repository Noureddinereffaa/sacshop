...
export default function OffersPage() {
  const { getDiscountInfo } = useCartStore();
            ...
            <div className="lg:col-span-1 space-y-6 text-right">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-sm font-bold text-gray-700">
                  ...
                  <span>تفعيل تلقائي في السلة</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-bold text-gray-700">
                  <CheckCircle2 size={18} className="text-green-500" />
                  <span>يطبق على كافة المنتجات</span>
                </div>
              </div>
            </div>
               ...
               >
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                     <div className="text-white text-center md:text-right space-y-6">
                        ...
                        <h3 className="text-5xl md:text-7xl font-black leading-none">خصم {percentage}%</h3>
                        <p className="text-white/80 text-xl font-bold">على إجمالي الطلبية في حال اختيار {minItems} منتجات</p>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl hover:shadow-2xl transition-all group overflow-hidden relative">
                 ...
                 <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-black text-gray-900 mb-4">نظام النجوم VIP</h3>
                    <p className="text-gray-500 font-medium mb-8 leading-relaxed">كلما زادت طلباتك، زادت نجومك في حسابك. ابدأ بتجميع النجوم لفتح تخفيضات تصل إلى 20% على إجمالي المسلة وهدايا طباعة مجانية.</p>
                    <Link href="/account" className="flex items-center justify-between bg-yellow-50 p-4 rounded-3xl group-hover:bg-yellow-600 transition-colors">
                       <span className="text-yellow-700 font-bold group-hover:text-white">عرض مستوى حسابي</span>
